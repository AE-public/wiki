...
![acp-imx6pos_jbtsl1.png](https://github.com/Avalue-AE/wiki/blob/master/images/RITY%20serious/acp-imx6pos_jbtsl1.png?raw=true)
...
![solo.jpg](https://github.com/Avalue-AE/wiki/blob/master/images/RITY%20serious/solo.jpg?raw=true)
  
3-2. Please select as below for Quad core then click “Run MFG-Tools”  
![pos_mfg_quad.jpg](https://github.com/Avalue-AE/wiki/blob/master/images/RITY%20serious/pos_mfg_quad.jpg?raw=true)
  
3-3. Press “Start” to flash image files  
![mfgtool_start.png](https://github.com/Avalue-AE/wiki/blob/master/images/RITY%20serious/mfgtool_start.png?raw=true)  
4. It will show “Done” after flashing is finish, then click “Stop” and
“Exit” to close the screen.  
![mfgtool_finish.png](https://github.com/Avalue-AE/wiki/blob/master/images/RITY%20serious/mfgtool_finish.png?raw=true)  
5. Set SW1 as below to boot from eMMC  
![pin_1_on.jpg](https://github.com/Avalue-AE/wiki/blob/master/images/RITY%20serious/pin_1_on.jpg?raw=true)
