...
3. Decompress clonezilla image file to root directory of USB disk.  
   ![clonezilla disk](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Linux/clonezilla_disk.png?raw=true)  
4. Plug the USB disk to USB port of OFT-XXW01. Power on the system and press `F12` to get into Boot Manager of BIOS. Please select USB Disk as boot device to boot up the system.  
   ![oft_linux_2](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Linux/oft_linux_2.png?raw=true)  
5. Please select the first option as below then press `enter`.
   ![oft_linux_3](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Linux/oft_linux_3.png?raw=true)  
6. Please type `Y` twice to start with restore process.  
   ![oft_linux_4](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Linux/oft_linux_4.png?raw=true)  
7. Please select `power off`. Please remove DC input and USB disk and then power on system again.  
   ![oft_linux_5](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Linux/oft_linux_5.png?raw=true)  
8. Default user name is `aes` and password is `123456`.  
   ![oft_linux_7](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Linux/oft_linux_7.png?raw=true)  