...
2. Format the USB disk with FAT32, untar the `USB_Installer.7z`.  
    ![flash_android_2](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/flash_android_2.png?raw=true)  
3. Express the Android image as below.  
    ![flash_android_3](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/flash_android_3.png?raw=true)  
4. Express `/flash_files/build-user/byt_t_crv2_64-user-fastboot-BCXXX-VXXXX.zip`.  
    ![flash_android_4](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/flash_android_4.png?raw=true)  
5. Choose the actual image as below, then replace those in the USB_Installer.  
    ![flash_android_5](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/flash_android_5.png?raw=true)  
> [!NOTE]  
...
![flash_android_5-1](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/flash_android_5-1.png?raw=true)  
And your USB_Installer should be like as below.
![flash_android_5-2](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/flash_android_5-2.png?raw=true)  
...
2. Power on your device and press `F12` to enter Boot Manager, then choose the USB you plug in.
    ![bios_2](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/bios_2.png?raw=true)
3. Auto load would start after few seconds.  
    ![flash_android_8](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/flash_android_8.png?raw=true)  
> [!NOTE]
...
1. Reboot and enter Android system.  
    ![flash_android_10](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/flash_android_10.png?raw=true)  
...
3. Plug in membrane keypad test cable on `JTB1` of the system. Here is approval sheet of approval sheet of [membrane keypad]() & [cable]().  
    ![key_1](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/key_1.png?raw=true)  
    ![key_2](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/key_2.png?raw=true)  
    ![key_3](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/key_3.png?raw=true)  
    ![key_4](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/key_4.png?raw=true)  
4. Please remove all the USB devices from OFT-XXW01 before you power on the system. Press `-` & `+` key of keypad when power on to get into DNX mode. If you have problem to get into DNX mode, please reflash BIOS again to solve this issue.
    ![key_5](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/key_5.png?raw=true)  
    ![6225125](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/6225125.png?raw=true)  
5. If you do not have membrane keypad on hand, you can use the way below to get into DNX mode.  
    1. Remove shielding cover of motherboard by removing 4 screws.
        ![dnx1](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/dnx1.png?raw=true)  
    2. Use the 4 screws to fix motherboard well and plug in Micro USB cable.
        ![dnx2](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/dnx2.png?raw=true)  
    3. Press `SW2` before you power on the system. Power on system right now and then you will see system already in DNX mode. You can release `SW2` right now.  
        ![dnx3](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/dnx3.png?raw=true)  
6. Run Intel Platform Flash tool and select `flash-EraseFactory.xml` in path `\2014WW46_BCX11_Intel_A44_0.0.46\flash_files\blankphone`.  
   ![flash_1](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/flash_1.png?raw=true)  
   Press “Start to flash” to erase eMMC of the system.  
   ![flash_2](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/flash_2.png?raw=true)  
7. Once you finish erase process, please select `flash.xml` in path `\2014WW46_BCX11_Intel_A44_0.0.46\flash_files\build-user\byt_t_crv2_64-user-fastboot-BCX11-V0.0.46` and then press `Start to flash`.
   ![flash_3](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/flash_3.png?raw=true)  
8. Once you finish the process, OFT-XXW01 will reboot automatically and get into Android.
   ![flash_4](https://github.com/Avalue-AE/wiki/blob/master/images/OFT-Android/flash_4.png?raw=true)  
